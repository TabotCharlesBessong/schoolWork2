// this is a program to find  the gcd of 2 numbers 
// the gcd  of 2  numbers  is the highest number  that can devide them both , that is  the HCF 

// #include<iostream>
// using namespace std;

// what is our approach , it is simple 
// 1.0 we will find the factors of the first number 
// 2.0 we will find the factprs  of the second number 
// 3.0 find the commmon factors  
// 4.0 multiply these  common factors 
